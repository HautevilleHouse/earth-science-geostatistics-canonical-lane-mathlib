...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "EarthScienceGeostatistics",
  theoremObject := "Earth Science Geostatistics Canonical Lane",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedGeostatisticsClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_geostatistics_endgame A
